const messages = {
  ...
  'es': {
    ...
    piso: {
      quando: 'desde mayo 2019 hasta septiembre',
      ...
      descrpiso: 'Sub-alquilamos 2 habitaciones en un modesto apartamento de 90 m2, que consta de 3 habitaciones en total, 1 baño con bañera + bidet, sala de estar, cocina, terraza cubierta para almacenamiento y bicicletas. <br>' +
        ...
        '<h5> Reglas </h5>' +
        'Estamos buscando a una persona tranquila, educada y silenciosa, respetuosa con los demás, la gente local vive en el condominio y no queremos que se hagan ruidos o fiestas. <br> ' +
        ...
        '- para la habitación individual: 300 € + 220 € = 520 € <br>' +
        '- para la doble: 300 € + 320 € = 620 € <br>' +
  ...
  'enUs': {
    ...
    piso: {
      ...
      descrpiso: 'We sub-rent 2 rooms in a modest 90m2 apartment, consisting of 3 total bedrooms, 1 bathroom with bath + bidet, living room, kitchen, covered terrace for storage and bicycles. <br> ' +
        ...
        '<h5> Rules </h5>' +
        'We are looking for a quiet, polite and silent person, respectful of others, local people live in the condominium, and do not want noise or parties to be made. <br>' +
        ...
        'A Spanish student currently lives there.' +
        '<h5> Period </h5>' +
        ...
        '- for the single room: 300 € + 220 € = 520 € <br>' +
        '- for the matrimonial: 300 € + 320 € = 620 € <br>' +
