    ...
    <div v-if="toolsext.isLang('it')">
      ...
      <CImgText src="">
        ...
        <p>
          ...
          del <strong>donare come risorsa e come ricchezza! Dare e donare mi apre al ricevere, crea relazioni basate
        ...
        <p>
          ...
          modo da realizzare i propri sogni e i propri progetti di vita. È un progetto serio che richiede, a chi ne vuol
          far parte, di
          ...
          membri supportati da chi ha già fatto esperienza in questo e in altri movimenti di Economia Solidale,
          attraverso
        ...
        <ul class="lista">
          <li>Qualcuno ti ha invitato e ti ha dato il link di accesso al sito <strong>AYNI GIFT*ECOnomy.</strong> e ti
            sei iscritto.
          </li>
          ...
          <li>
            Entri nel Canale Telegram <strong>AYNI BIBLIO</strong> che è un canale di informazioni in cui vengono
            postati
            comunicati, notizie e novità sul movimento.
          </li>
          <li>
            Infine abbiamo Telegram <strong>AYNI HELP</strong> dove puoi entrare ogni volta che dovessero sorgerti
            domande
        ...
        <ol class="lista">
          ...
          <li>Assistere ad uno <strong>Zoom di Benvenuto</strong> (Video-Conferenza) in cui potrai conoscere il
          ...
          <li>Attivare almeno <strong>2 metodi di pagamento</strong>.
            ...
            Sono consigliati il conto <strong>Revolut</strong> o <strong>N26</strong> come seconda opzione e <strong>Western
        ...
        <CTitleBanner title="Visualizza in Anteprima I 3 Passi (clicca qui)" bgcolor="bg-green-5" canopen="true"
          ...
          <p>La chat dove sono Sognatore è la stessa e con le stesse persone aperta nel passo 2 (dove io ero Mediatore)
        ...
        <p class="text-blue-10 q-ma-lg clBorderImportant text-center" style="font-size: 1.15rem;">La Chat Automatica
          <strong>AYNI BOT</strong> mi invierà tutte le istruzioni che dovrò compiere, al momento opportuno!</p>
    ...
    <div v-else-if="toolsext.isLang('es')">
      ...
      <CImgText src="">
        ...
        <CTitleBanner title="Previsualización de los 3 pasos (click aquí)" bgcolor="bg-green-5" canopen="true"
                      :visible="false" imgpreview="statics/images/passo_1.jpg">
          <p>Desde el momento en que sé el día de la salida de mi billete, los pasos a seguir
            serán estos:</p>
          <div class="text-center">
            <q-img src="statics/images/passo_1.jpg" class="img"></q-img>
          </div>
    ...
    <div v-else-if="toolsext.isLang('pt')">
      ...
      <CImgText src="">
        ...
        <p>
          ...
          membros apoiados por aqueles que já tiveram experiência neste e em outros movimentos de Economia Solidária,
          através de
        ...
        <ul class="lista">
          ...
          <li>Vá para o chat Telegrama <strong>Ayni EMPOWER</strong>, lugar onde nos encontramos, acolhemos novas
            pessoas
            convidados,
    ...
    <div v-else-if="toolsext.isLang('fr')">
      ...
      <CImgText src="">
        ...
        <ol class="lista">
          ...
          <li>Assistance à une <strong>Zoom de bienvenue</strong> (vidéoconférence) où vous pouvez vous renseigner sur
            la
        ...
        <p class="clBorderImportant" style="border-color: deepskyblue">
          ...
          Au cas où le flux de personnes et d'invités ne permettrait pas de maintenir et de réaliser ce qui a été
        ...
        <CTitleBanner title="Aperçu des 3 étapes (cliquez ici)" bgcolor="bg-green-5" canopen="true"
                      :visible="false" imgpreview="statics/images/passo_1.jpg">
          <p>À partir du moment où je connais le jour de départ de mon billet, les démarches à effectuer
          ...
          <p>Le chat où je suis Rêveur est le même et avec les mêmes personnes ouvert à l'étape 2 (où j'étais Médiateur)
